    ...
    return BlocConsumer<AuthCubit, AuthState>(
      ...
      builder: (context, authState) {
        ...
        final isAnonymous = switch (authState) {
          Authenticated(:final isAnonymous) => isAnonymous,
          AuthFailureState(:final isAnonymous) => isAnonymous,
          _ =>
            context.read<AuthCubit>().getCurrentUserUseCase()?.isAnonymous ??
                false,
        };
        final user = switch (authState) {
          Authenticated(:final user) => user,
          AuthFailureState(:final user) => user,
          _ => context.read<AuthCubit>().getCurrentUserUseCase(),
        };
              ...
              if (isAnonymous) ...[
                ...
                ElevatedButton.icon(
                  ...
                  icon: isLoading
                      ...
                      : const Icon(LucideIcons.uploadCloud, size: 20),
                  label: Text(
                    isLoading
                        ? 'Đang kết nối Google...'
                        : 'Liên kết Google để lưu trữ vĩnh viễn',
                  ),
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: const Text(
                        'Tạo file hồ sơ tài sản & hóa đơn chuẩn bảo hiểm',
                      ),
                    ...
                    ListTile(
                      ...
                      subtitle: const Text(
                        'Quản lý phân quyền vợ/chồng cùng xem thiết bị',
                      ),
                      trailing: const Icon(Icons.chevron_right),
                    ...
                    ListTile(
                      ...
                      subtitle: const Text(
                        'Quét mã nhanh để tham gia quản lý nhà',
                      ),
                      trailing: const Icon(Icons.chevron_right),
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: const Text(
                        'Nhắc trước hạn 7, 14, 30 ngày qua OneSignal',
                      ),
                      trailing: Switch(
                        value: true,
                        onChanged: (val) {
